...
train_images_dir = '../dataset/roboflow/train'
train_annotations_filename = '../dataset/roboflow/train.json'
val_images_dir = '../dataset/roboflow/valid'
val_annotations_filename = '../dataset/roboflow/val.json'
log_dir = '../Pelee_keras_logs'
...
# load weights
weights_path = '../Pelee_keras_logs/pelee_coco_07_loss-4.2268_val_loss-4.2205.h5'
